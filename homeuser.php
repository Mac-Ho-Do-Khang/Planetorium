  ...
  <header class="header">
    ...
    <nav class="header-nav">
      <ul class="header-nav-list">
        ...
        <li>
          <a class="header-nav-link" href="index.php?page=login">Login</a>
        </li>
        <li><a class="header-nav-link" href="index.php?page=register">Register</a></li>
        <div class="user-info">
      ...
      <div
        ...
        <div class="planet">
          <div class="planet-img">
            <img src="content/img/meals/planet1.png" />
          </div>
        ...
        <div class="planet">
          <div class="planet-img">
            <img src="content/img/meals/planet2.png" />
          </div>
          <div class="planet-content">
            <div class="tag-area">
    ...
    <section
      ...
      <div
        ...
        <figure class="gallery-item">
          <img src="content/img/planets/pla1.png" />
        </figure>
        <figure class="gallery-item">
          <img src="content/img/planets/pla13.png" />
        </figure>
        <figure class="gallery-item">
          <img src="content/img/planets/pla3.png" />
        </figure>
        <figure class="gallery-item">
          <img src="content/img/planets/pla6.png" />
        </figure>
        <figure class="gallery-item">
          <img src="content/img/planets/pla5.png" />
        </figure>
        <figure class="gallery-item">
          <img src="content/img/planets/pla7.png" />
        </figure>
        <figure class="gallery-item">
        ...
        <figure class="gallery-item">
          <img src="content/img/planets/pla10.png" />
        </figure>
        <figure class="gallery-item">
          <img src="content/img/planets/pla11.png" />
        </figure>
        <figure class="gallery-item">
          <img src="content/img/planets/pla12.png" />
        </figure>
        <figure class="gallery-item">
          <img src="content/img/planets/pla4.png" />
        </figure>
      </div>
    </section>
        ...
        <div class="cta grid-container" style="--column: 2">
          <div class="cta-box">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
              ...
              // Mapping the selected option to a meaningful value
              switch ($hearfrom) {
                case '1':
              ...
              $sql = "INSERT INTO $tb_name (fullname, email, hearfrom, registerdate) 
                      VALUES ('$fullname', '$email', '$hearfrom', NOW())";
              mysqli_query($conn, $sql);
            }
            ?>
